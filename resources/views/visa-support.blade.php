...
<div class="relative bg-[#202124] text-white overflow-hidden">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="relative z-10">
        <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          Профессиональная визовая поддержка
        </h1>
        <p class="text-lg md:text-xl text-gray-300 mb-8 max-w-lg">
          Полное сопровождение визовых процессов для обучения и работы за
          рубежом. Поможем собрать документы, подготовиться к собеседованию
          и получить визу в кратчайшие сроки.
        </p>
        ...
        <div class="mt-10 flex flex-wrap gap-6">
          <div class="flex items-center">
            ...
            <span class="ml-2">95% успешных виз</span>
          </div>
          <div class="flex items-center">
            <svg class="w-8 h-8 text-[#800F12]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            </svg>
            <span class="ml-2">Поддержка 24/7</span>
          </div>
          <div class="flex items-center">
            <svg class="w-8 h-8 text-[#800F12]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            </svg>
            <span class="ml-2">Опыт 10+ лет</span>
          </div>
        </div>
      </div>
      ...
      <div class="relative">
        ...
        <div
          ...
          <div class="">
            <img src="{{ asset('images/ilec-photo-8.jpg') }}" alt="Визовая поддержка"
  ...
  <!-- Абсолютно позиционированные декоративные элементы -->
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
    ...
    <div class="md:col-span-5">
      <div class="w-full max-h-[680px] overflow-hidden rounded-2xl border border-gray-200 shadow-md">
        <img src="{{ asset('images/ilec-photo-9.jpg') }}" alt="Студент в Германии" class="w-full h-full object-cover"
    ...
    <div class="md:col-span-7">
      <div class="bg-white rounded-2xl p-8 md:p-10 shadow-md border border-gray-200 space-y-6">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">
          Ваш путь в Германию начинается здесь
        </h2>

        <p class="text-gray-700 text-base leading-relaxed">
          За последние годы мы помогли сотням студентов, выпускников и специалистов получить немецкую визу и
          реализовать свои карьерные планы в Европе. Наши клиенты — молодые люди из разных уголков Кыргызстана,
          которые уже учатся и работают в Германии.
        </p>

        <p class="text-gray-700 text-base leading-relaxed">
          Мы знаем, как избежать отказов, правильно подготовить документы и пройти собеседование в посольстве.
          Индивидуальный подход, проверенные шаблоны, полное сопровождение — всё это делает процесс получения визы
...
<section class="py-16 md:py-24 px-6 bg-[#202124] text-white">
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-16">
      <h2 class="text-3xl md:text-4xl font-bold mb-4">Наши сертификаты и аккредитации</h2>
      <p class="text-lg text-gray-300 max-w-3xl mx-auto">
        Мы официально аккредитованы ведущими образовательными учреждениями и визовыми центрами
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
      ...
      <div
        ...
        <div
          ...
          <div class="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
            <h3 class="text-xl font-bold text-white">Лицензция</h3>
            <p class="text-gray-300 mt-1">Общество с ограниченной общественностью образовательный цент</p>
          </div>
        </div>
        <img src="{{ asset('images/certificate-1.webp') }}" alt="Сертификат ICEF"
      ...
      <div
        ...
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 flex items-end p-6">
          <div class="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
            <h3 class="text-xl font-bold text-white">Разрешение</h3>
            <p class="text-gray-300 mt-1">На право деятельности, связанной с трудоустройством граждан Кыргызской
              Республики </p>
          </div>
        </div>
        <img src="{{ asset('images/certificate-2.webp') }}" alt="Лицензия Tier 4"
          class="h-full max-h-full w-auto object-contain transition-transform duration-700 group-hover:scale-105">
      </div>
    </div>
